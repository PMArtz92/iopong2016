...
Game = {
  ...
  Runner: {
    ...
    addEvents: function() {
      ...
      Game.addEvent(document, 'mouseup',   this.mouseup1.bind(this));
      Game.addEvent(document, 'mousedown',   this.mousedown1.bind(this));
        Game.addEvent(document, 'mouseup',   this.mouseup2.bind(this));
        Game.addEvent(document, 'mousedown',   this.mousedown2.bind(this));
     Game.addEvent(document, "p1DownPress",   this.p1DownPress.bind(this));
     Game.addEvent(document, "p1DownRelease",   this.p1DownRelease.bind(this));
     Game.addEvent(document, "p1UpPress",   this.p1UpPress.bind(this));
     Game.addEvent(document, "p1UpRelease",   this.p1UpRelease.bind(this));

     Game.addEvent(document, "p2DownPress",   this.p2DownPress.bind(this));
     Game.addEvent(document, "p2DownRelease",   this.p2DownRelease.bind(this));
     Game.addEvent(document, "p2UpPress",   this.p2UpPress.bind(this));
     Game.addEvent(document, "p2UpRelease",   this.p2UpRelease.bind(this));
     Game.addEvent(document, "gameStart",   this.gameStart.bind(this));

    },

    onkeydown: function(ev) { if (this.game.onkeydown) this.game.onkeydown(ev.keyCode); },
    onkeyup:   function(ev) { if (this.game.onkeyup)   this.game.onkeyup(ev.keyCode);  E = ev.keyCode; console.log(ev);},

    mouseup1:   function(ev) {   /*console.log(ev);*/if(p1 == 0) this.game.onkeyup(82); /*else if(p1<0) this.game.onkeyup(65);*/   },
    mousedown1:   function(ev) {  if(p1 == 1) this.game.onkeydown(82); else if(p1==2) this.game.onkeydown(49);  },

      mouseup2:   function(ev) {   /*console.log(ev);*/if(p1 == 0) this.game.onkeyup(65); /*else if(p1<0) this.game.onkeyup(65);*/   },
      mousedown2:   function(ev) {  if(p1 <0) this.game.onkeydown(65); /*else if(p1<0) this.game.onkeydown(65);*/  },
      p1DownPress:   function(ev) {  this.game.onkeydown(65); },
      p1DownRelease:   function(ev) {  this.game.onkeyup(65); },
      p1UpPress:   function(ev) {  this.game.onkeydown(82); },
      p1UpRelease:   function(ev) {  this.game.onkeyup(82); },

      p2DownPress:   function(ev) {  this.game.onkeydown(76); },
      p2DownRelease:   function(ev) {  this.game.onkeyup(76); },
      p2UpPress:   function(ev) {  this.game.onkeydown(80); },
      p2UpRelease:   function(ev) {  this.game.onkeyup(80); },

      gameStart:   function(ev) {  this.game.onkeydown(50); },
